...
def hero() -> str:
    ...
    name = "Raaaaaymond"
    size = fit("display", name, 600, 104)
    b.append(T(450, 196, name, "display", size, INK, anchor="middle"))
    role = "systems   ·   engines   ·   proofs   ·   music"
    rw = caps_width(role, 11, .28)
    b.append(caps(450, 238, role, 11, MUTED, "middle", .28))
    b.append(hairline(234, 450 - rw / 2 - 60, 450 - rw / 2 - 22, HAIR2))
    b.append(hairline(234, 450 + rw / 2 + 22, 450 + rw / 2 + 60, HAIR2))
    y = 292
    for line in EPIGRAPH:
        b.append(T(450, y, line, "texti", 18.5, INK2, anchor="middle"))
        y += 27
    b.append(asterism(450, y + 14))
    return svg(h, "".join(b), ["display", "caps", "texti"], "", "Raaaaaymond — L0stInFades")
